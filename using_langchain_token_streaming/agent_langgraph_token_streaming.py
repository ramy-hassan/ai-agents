...
async def main():
    ...
    abot = Agent(bedrock_llm, [get_nearest_store, get_offers_for_product, get_offers_by_retailer, add_to_shopping_cart], system_prompt=system_prompt, checkpointer=memory)

    messages = [HumanMessage(content="what is the best offer for banana in Rewe?")]
