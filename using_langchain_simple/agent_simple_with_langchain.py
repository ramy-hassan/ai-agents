...
# @tool
# def get_stores_for_specific_retailers(retailer: str) -> str:
#     """Return the nearest store to the given retailer."""
#     return ("store for " + retailer + " is at 123 Main St")
...
# # Call the agent
agent.graph.invoke({"messages": messages})
